...
CREATE TABLE `bairros` (
  ...
  UNIQUE KEY `idbairros_UNIQUE` (`idbairros`)
...
CREATE TABLE `cidades` (
  ...
  UNIQUE KEY `idcidades_UNIQUE` (`idcidades`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2016-09-19 13:55:11',NULL),('diagnostics.include_raw','OFF','2016-09-19 13:55:11',NULL),('ps_thread_trx_info.max_length','65535','2016-09-19 13:55:11',NULL),('statement_performance_analyzer.limit','100','2016-09-19 13:55:11',NULL),('statement_performance_analyzer.view',NULL,'2016-09-19 13:55:11',NULL),('statement_truncate_len','64','2016-09-19 13:55:11',NULL);
...
CREATE TABLE `tamanhos` (
  ...
  `quantidade_sabores` int(11) NOT NULL,
  PRIMARY KEY (`idtamanhos`),
  UNIQUE KEY `idtamanhos_UNIQUE` (`idtamanhos`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-16 21:50:30
